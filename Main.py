    ...
    while flag == False:
        ...
        if choice == 'play': 
            ...
            while len(hands[z]) < int(position):
                position = input('Write the position of the card you want to use starting from 1: ')
            ...
            if chosen_card[0] == '8' and len(hands[z]) == 1:
                ...
                print('The card you chose does not fit choose again')
